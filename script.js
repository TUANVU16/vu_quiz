...
const newRound = function () {
  ...
  gameContainerHeadingEl.innerText = `問 ${
    currentGameResult.length + 1
  } - このアイテムの名前を推測してください`;
